...
function TAccountsStrategy(options, verify) {
  ...
  options.authorizationURL = options.authorizationURL || ' http://accounts.pdi.tid.es/telefonica/oauth/authorize';
  options.tokenURL = options.tokenURL || 'http://10.95.213.40:3000/telefonica/oauth/token';
  options.profileURL = options.profileURL || 'https://10.95.213.40:7443/accounts/v1/telefonica/users/me';
