...
function TAccountsStrategy(options, verify) {
  ...
  options.authorizationURL = options.authorizationURL || 'http://accounts.tid.es/telefonica/oauth/authorize';
  options.tokenURL = options.tokenURL || 'http://accounts.tid.es/telefonica/oauth/token';
